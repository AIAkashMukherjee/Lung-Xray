...
# from src.pipeline.stage_02_data_transform import DataValidationPipe
from src.pipeline.stage_02_data_transform import DataTransfromPipe
from src.pipeline.stage_03_model_trainer import ModelTrainerPipe
